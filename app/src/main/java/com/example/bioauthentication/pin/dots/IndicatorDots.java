package com.example.bioauthentication.pin.dots;
...
import com.example.bioauthentication.pin.dots.ResourceUtils;
...
public class IndicatorDots extends LinearLayout {
    ...
    @IntDef({com.example.bioauthentication.pin.dots.IndicatorDots.IndicatorType.FIXED, com.example.bioauthentication.pin.dots.IndicatorDots.IndicatorType.FILL, com.example.bioauthentication.pin.dots.IndicatorDots.IndicatorType.FILL_WITH_ANIMATION})
    ...
    public IndicatorDots(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mIndicatorType = typedArray.getInt(R.styleable.PinLockView_indicatorType,
                    com.example.bioauthentication.pin.dots.IndicatorDots.IndicatorType.FIXED);
        } finally {
            typedArray.recycle();
        }
    ...
    public
    @com.example.bioauthentication.pin.dots.IndicatorDots.IndicatorType
    int getIndicatorType() {
        return mIndicatorType;
    }

    public void setIndicatorType(@com.example.bioauthentication.pin.dots.IndicatorDots.IndicatorType int type) {
